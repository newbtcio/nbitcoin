...
- A new [document](https://github.com/bitcoin/bitcoin/blob/master/doc/bitcoin-conf.md)
  about the `nbitcoin.conf` file describes how to use it to configure
  Bitcoin Core.
...
- #14057 logging: Only log `using config file path_to_nbitcoin.conf` message on startup if conf file exists (leishman)
