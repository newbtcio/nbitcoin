...
- #15513 add "sections" info to example nbitcoin.conf (fanquake)
...
- #16448 add note on precedence of options in nbitcoin.conf (fanquake)
...
- #16621 add default nbitcoin.conf locations (GChuf)
...
- #16812 Fix whitespace errs in .md files, nbitcoin.conf, and Info.plist.in (ch4ot1c)
